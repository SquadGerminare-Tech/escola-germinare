...
const NavBar = (/*props: tipo*/) => {
    ...
    const showItem = () => {
        if(esconder.current.style.visibility == 'hidden'){
            ...
            esconder.current.style.transition = " visibility 2s, opacity 1s linear, margin-left 0.7s"
            ...
            esconder.current.style.transition = " visibility 1s, opacity 0.2s linear, margin-left 1s"
    ...
    return(
            ...
            <div style={{height: "80px"}}>
                <ul className='content'>
                    ...
                    <button id='btn' onClick={showItem} className='btnLupa'><img src={lupa} alt="lupa" style={{width: '20px'}}/></button>
                    <input type="text" className='inputStyle' ref={esconder} onChange={ouvirInput} id="hiddenInput" onKeyPress={(e) => {
