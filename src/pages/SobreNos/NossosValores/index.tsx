...
const NossosValores = () => {
    ...
    return(
        <div style={{backgroundColor: '#E8E7E7', paddingBottom: '100px'}}>
        <StyleValores>
            <div className='conteudoValores'>
                <h2>Nossos Valores</h2>
                <p>Amparados neles, tomamos decisões e trabalhamos para <span>sermos os melhores naquilo que fazemos.</span>
                Por meio deles, nos reconhecemos e nos aproximamos.</p>
            </div>
